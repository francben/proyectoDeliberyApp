...
class RolesControllerTest < ActionController::TestCase
  ...
  test "should create rol" do
    assert_difference('Rol.count') do
      post :create, rol: { descripcion_rol: @rol.descripcion_rol, estado_rol: @rol.estado_rol, nombre_rol: @rol.nombre_rol }
    end
  ...
  test "should update rol" do
    patch :update, id: @rol, rol: { descripcion_rol: @rol.descripcion_rol, estado_rol: @rol.estado_rol, nombre_rol: @rol.nombre_rol }
    assert_redirected_to rol_path(assigns(:rol))
  end
